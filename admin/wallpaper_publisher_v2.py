#!/usr/bin/env python3
"""
Wallpaper Publisher V2 - Enhanced with Image Optimization
...
class WallpaperPublisherV2:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Wallpaper Publisher V2 - With Image Optimization")
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="Wallpaper Publisher V2", font=("Arial", 18, "bold"))
        title_label.pack(pady=(0, 5))
        
        subtitle_label = ttk.Label(main_frame, text="With Automatic Image Optimization & Multiple Resolutions", font=("Arial", 10))
    ...
    def _process_image_thread(self):
        ...
        try:
            ...
            results = self.image_processor.process_all_resolutions(self.selected_image_path)
    ...
    def _generate_metadata_thread(self, api_key: str):
        ...
        try:
            ...
            # Create enhanced prompt for metadata generation
            prompt = """
            Analyze this wallpaper image and generate comprehensive metadata for a wallpaper website. 
            ...
            Guidelines:
            - Title should be catchy, descriptive, and SEO-friendly
            - Description should include relevant keywords and describe the image appeal
            - Choose the most appropriate category based on the dominant theme
            - Provide 3-5 relevant tags that describe colors, style, objects, mood, etc.
            - Consider this is for mobile wallpapers so mention if it's suitable for phones
            """
