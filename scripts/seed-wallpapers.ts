...
import { WallpaperInsert } from '../lib/database.types.js'

const featuredWallpapers: WallpaperInsert[] = [
  // Nature Category
  {
  ...
  // Flowers Category
  {
    title: "Beautiful Flowers Garden",
    description: "Vibrant flower garden with colorful blooms and natural beauty. Perfect for nature and flower enthusiasts.",
    category: "Flowers",
    tags: ["flowers", "garden", "colorful", "blooms", "nature", "beautiful", "vibrant"],
    image_url: "/beautiful-flowers-category-wallpaper.png"
  },

  // Photography Category
  {
    title: "Artistic Black White Photography",
    description: "Stunning black and white artistic photography with dramatic contrast and composition. Perfect for photography enthusiasts.",
    category: "Photography",
    tags: ["photography", "black and white", "artistic", "dramatic", "contrast", "composition"],
    image_url: "/artistic-photography-black-white.png"
  },

  // Energy Category
  {
    title: "Lightning Energy Electric",
    description: "Powerful lightning bolts with electric energy effects. Perfect for those who love dynamic and energetic wallpapers.",
    category: "Energy",
    tags: ["lightning", "energy", "electric", "powerful", "dynamic", "storm", "nature"],
    image_url: "/lightning-energy-electric.png"
  },

  // Technology Category (Additional)
  {
    title: "Futuristic Technology Gadgets",
    description: "Advanced futuristic technology gadgets and devices with holographic displays. Perfect for tech enthusiasts.",
    category: "Technology",
    tags: ["futuristic", "technology", "gadgets", "holographic", "advanced", "devices", "sci-fi"],
    image_url: "/futuristic-technology-gadgets.png"
  }
]
